...
fn get_power_cubes(line: &str) -> u32 {
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";
    ...
    #[test]
    fn are_power_cubes_correct() {
        assert_eq!(
            get_power_cubes("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green"),
            48
        );
        assert_eq!(
            get_power_cubes("Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue"),
            12
        );
        assert_eq!(
            get_power_cubes(
        ...
        assert_eq!(
            get_power_cubes("Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"),
            36
        );
    }
}
